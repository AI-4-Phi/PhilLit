...
**Status**: All four phases complete (2026-07-13). Phases 1–3 merged to `main` as plugin version 0.2.0; Phase 4 as 0.2.1. Only the Windows checks (parity-gate Step 6) remain deferred.
