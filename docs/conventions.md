...
- `EVIDENCE-ABSTRACT` — abstract corroborated at the barrier by a live fetch that still served the same text (the enrichment ledger is a cache, not the authority): characterize/summarize/quote from the sourced abstract text
